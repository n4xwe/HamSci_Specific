...
sudo cp ~/src/NANOVNA/nanovna-saver/NanoVNASaver_48x48.png /usr/share/pixmaps/NanoVNASaver_48x48.png

echo "[Desktop Entry]
Name=NanoVNA-Saver
GenericName=VNA Software
Comment=Runs NanoVNA Saver
Exec=python3 ~/src/NANOVNA/nanovna-saver/nanovna-saver.py
